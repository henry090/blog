---
title: "BERT from R for Azerbaijani"
description: |
...
knitr::include_graphics("emb.png")
```
...
dt_data('https://raw.githubusercontent.com/QSS-Analytics/Datasets/master/bert1.csv',5000)
...
history = model %>% fit(
  ...
  epochs=epochs,
  batch_size=bch_size, 
  callbacks = list(callback_csv_logger('history_bert.csv')),
  validation_data=list(concat2, targets2))
```
